...
from library_main import add_book_gui, delete_book_gui, lend_book_gui, display_books
class TestSystem(unittest.TestCase):
    ...
    @patch("library_model.load_book",return_value=[{"title":"T","author":"A","year":2021,"status":"available"}])
    def test_display(self,ml): out=display_books(None); self.assertIn("T",out)
